...
def get_parser():
    ...
    parser.add_argument('--image', type=str, default='./figure/demo/1403_10.jpg', help='input image')
    parser.add_argument('opts', help='see ./config/ade20k/ade20k_pspnet101.yaml for all options', default=None, nargs=argparse.REMAINDER)
