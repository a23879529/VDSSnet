...
class VDSSNet(nn.Module):
    def __init__(self, in_c=4, out_c=3, only_residual=True):
        ...
        self.res1 = DilatedBlock(64, dilation=2)
        self.res2 = DilatedBlock(64, dilation=2)
        self.res3 = DilatedBlock(64, dilation=2)
        self.res4 = DilatedBlock(64, dilation=2)
        self.res5 = DilatedBlock(64, dilation=2)
        self.res6 = DilatedBlock(64, dilation=2)
        self.res7 = DilatedBlock(64, dilation=2)
