...
class VDSSNet(nn.Module):
    def __init__(self, in_c=9, out_c=3):
        ...
        #Encoder
        self.ssconv1 = nn.Conv2d(in_c, 64, 3, 1, 1) #To up_conv3
        ...
        self.addictionssconv3 = SmoothDilatedResidualBlock(256, 3, 2, 1, 256)
        ...
        self.addictionssconv4 = SmoothDilatedResidualBlock(128, 3, 2, 1, 128)
        ...
        self.ssconv18 = SmoothDilatedResidualBlock(64, 3, 1, 1, 64)
        self.ssconv19 = SmoothDilatedResidualBlock(64, 3, 2, 1, 64)
        self.ssconv20 = SmoothDilatedResidualBlock(64, 3, 3, 1, 64)
